...
class Position:
    ...
    def get_closest_piece(self):
        ...
        for piece in self.pieces:
            ...
            print(coord2)
            print(mouse_coord)
            if self.distance(mouse_coord,coord2) < self.scrn_size/10:
                return piece
        return None
...
class Piece:
    ...
    def update_coord(self):
        self.x,self.y = self.img_x*8/self.scrn_size,self.img_y*8/self.scrn_size
    def take_piece(self):
